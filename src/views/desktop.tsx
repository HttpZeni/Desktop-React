  ...
  return (
    ...
    {isVisible && (
      ...
      <div className="flex flex-col flex-wrap content-start gap-x-5 gap-y-2 h-full">
        <DesktopIcon title="Peter" width={100} height={100} open="Peter" setOpen={setCurrentOpen} />
        <DesktopIcon title="Peter2" width={100} height={100} open="Peter2" setOpen={setCurrentOpen} />
      </div>
    </div>
  );
}
